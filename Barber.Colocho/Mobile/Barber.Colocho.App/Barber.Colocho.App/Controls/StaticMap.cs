...
namespace Barber.Colocho.App.Controls
{
    public class StaticMap : Image
    {
        ...
        /// </summary>
        public static readonly BindableProperty PinsProperty = BindableProperty.Create(nameof(Pins), typeof(IEnumerable<Pin>), typeof(StaticMap), propertyChanged: OnPropertyChanged);
        ...
        private void SetImageSource()
        {
            ...
            if (Pins != null)
            {
                ...
                {
                    url += $"&markers=color:0xDA274D|{pin.Position.Latitude},{pin.Position.Longitude}";
                }
            }
            if (Polylines != null)
            {

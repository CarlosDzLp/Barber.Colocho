...
namespace Barber.Colocho.DataAccess.Migrations
{
    ...
    [Migration("20241129231049_add15")]
    partial class add15
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Barber.Colocho.Entities.Tables.Error", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Barber.Colocho.Entities.Tables.Plan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Barber.Colocho.Entities.Tables.Suscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("FinishSuscription")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("InitSuscription")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Barber.Colocho.Entities.Tables.Suscription", b =>
                {
                    b.HasOne("Barber.Colocho.Entities.Tables.Company", "Company")
                        .WithMany("Suscription")
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Barber.Colocho.Entities.Tables.Plan", "Plan")
                        .WithMany("Suscription")

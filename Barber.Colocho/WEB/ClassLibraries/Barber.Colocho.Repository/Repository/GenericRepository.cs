...
namespace Barber.Colocho.Repository.Repository
{
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        private async Task<int> SaveCommitAsync()
        {
            ...
            try
            {
                ...
                await transaction.CommitAsync(); // Si todo va bien, realiza el commit de la transacción
                return saved;
            }
            catch (DbUpdateException dbEx)
            {
                // Manejo de errores específico de EF Core
                // Puedes acceder a dbEx.InnerException para obtener detalles más precisos
